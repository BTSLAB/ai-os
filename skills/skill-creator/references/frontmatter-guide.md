...
The description is the runtime's only clue about whether to load your skill. It must answer:
1. **What** does this skill do?
2. **When** should the runtime use it?
...
# No trigger conditions — the runtime doesn't know WHEN
...
Prevents the runtime from auto-triggering. Use for destructive operations.
...
model: sonnet
context: fork
allowed-tools: Bash(python3 skills/skill-name/scripts/*)
---
```
