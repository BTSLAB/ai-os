...
model: sonnet
context: fork
allowed-tools: Bash(python3 skills/email-digest/scripts/*)
user-invocable: true
---
...
```bash
python3 skills/email-digest/scripts/fetch_emails.py --hours 24
```
...
```bash
python3 skills/email-digest/scripts/analyze_emails.py --input emails.json
```
...
```bash
python3 skills/email-digest/scripts/post_to_slack_blocks.py --input analysis.json
```
...
```bash
python3 skills/email-digest/scripts/create_gmail_drafts.py --input analysis.json
```
...
```bash
# Daily at 7am
0 7 * * * aios -p "/email-digest" --output-format json >> logs/email-digest.log
```
