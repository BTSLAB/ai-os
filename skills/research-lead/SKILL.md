...
model: sonnet
context: fork
allowed-tools: Bash(python3 skills/research-lead/scripts/*)
user-invocable: true
---
...
```bash
python3 skills/research-lead/scripts/research_lead.py "https://www.linkedin.com/in/username/"
```
...
```bash
python3 skills/research-lead/scripts/scrape_linkedin.py "LINKEDIN_URL"
```
...
```bash
python3 skills/research-lead/scripts/research_with_perplexity.py --company "Company Name" --person "Person Name" --role "Their Role"
```
...
```bash
python3 skills/research-lead/scripts/analyze_with_openai.py --type lead_profile --profile profile.json --research research.json
python3 skills/research-lead/scripts/analyze_with_openai.py --type pain_gain_operational --profile profile.json --research research.json
python3 skills/research-lead/scripts/analyze_with_openai.py --type pain_gain_automation --profile profile.json --research research.json
python3 skills/research-lead/scripts/analyze_with_openai.py --type connection_request --profile profile.json --research research.json
python3 skills/research-lead/scripts/analyze_with_openai.py --type dm_sequence --profile profile.json --research research.json
```
...
```bash
python3 skills/research-lead/scripts/generate_review_report.py --data combined_analysis.json
```
...
```bash
python3 skills/research-lead/scripts/update_google_sheet.py --data combined_analysis.json --sheet-id "SHEET_ID"
```

### Step 6: Post to Slack (Optional)

```bash
python3 skills/research-lead/scripts/post_lead_review_to_slack.py --data combined_analysis.json
```
...
```bash
python3 skills/research-lead/scripts/batch_research_leads.py --source airtable
```
