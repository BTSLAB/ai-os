...
Trigger: Runs async after every assistant response via the Stop hook.
...
def main():
    ...
    try:
        ...
        # Read hook input from stdin (the runtime passes context)
        ...
        # Hooks should never crash the runtime — fail silently
        pass
